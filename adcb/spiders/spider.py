...
from ..items import AdcbItem
from itemloaders.processors import TakeFirst


class AdcbSpider(scrapy.Spider):
	name = 'adcb'
	start_urls = ['https://www.adcb.com/en/about-us/media-centre/news/newsjson.json']
	...
	def parse_post(self, response, date, title):
		...
		item = ItemLoader(item=AdcbItem(), response=response)
